...
run_ray.py --input-table "coronaomop_unstable.note" --output-table "note_nlp_medoc" --write-mode "full" --process "cuda" --limit 100 --num-replica 2 --num-gpus 1 --doc-batch-size 10 --sentence_batch_size 128
